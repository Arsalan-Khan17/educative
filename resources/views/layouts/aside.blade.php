        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{Route::currentRouteName() == 'classes'?'active':''}}">
              ...
              @if(Auth::user()->role_id == 1)
                  <li class="menu-item {{Route::currentRouteName() == 'groups'?'active':''}}">
                      <a href="{{route('groups')}}" class="menu-link">
                          <i class="menu-icon tf-icons bx bx-cube-alt"></i>
                          <div data-i18n="Misc">Groups</div>
                      </a>
                  </li>
                  <li class="menu-item {{Route::currentRouteName() == 'sessions'?'active':''}}">
                      <a href="{{route('sessions')}}" class="menu-link">
                          <i class="menu-icon tf-icons bx bx-cube-alt"></i>
                          <div data-i18n="Misc">Sessions</div>
                      </a>
                  </li>
                  <li class="menu-item {{Route::currentRouteName() == 'subjects'?'active':''}}">
                      <a href="{{route('subjects')}}" class="menu-link">
                          <i class="menu-icon tf-icons bx bx-collection"></i>
                          <div data-i18n="Basic">Subjects</div>
                      </a>
                  </li>
                  <li class="menu-item {{Route::currentRouteName() == 'teachers'?'active':''}}">
                      <a href="{{route('teachers')}}" class="menu-link">
                          <i class="menu-icon tf-icons bx bx-collection"></i>
                          <div data-i18n="Basic">Teachers</div>
                      </a>
                  </li>
                  <li class="menu-item {{Route::currentRouteName() == 'students'?'active':''}}">
